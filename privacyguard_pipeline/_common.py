...
WHITELIST: set[str] = {
    ...
    "роза", "лилия", "ромашка", "гвоздика", "фиалка", "ландыш",
    "вишня", "груша", "слива", "яблоко",
    "надежда", "вера", "любовь", "софия",
    "рай", "ад", "мир",
    "воля", "слава", "искра",
    "заря", "утро", "вечер", "ночь",
    "камень", "река", "озеро", "море", "поле", "лес",
    "зима", "весна", "лето", "осень",
    "север", "юг", "запад", "восток",
    "белый", "черный", "красный", "синий", "зеленый",
    "белое", "черное", "красное", "синее", "зеленое",
    "белая", "черная", "красная", "синяя", "зеленая",
}
